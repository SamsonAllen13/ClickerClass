...
namespace ClickerClass.Items.Accessories
{
	public class BigRedButton : ClickerItem
	{
		public override void SetStaticDefaults()
		{
			...
			ClickEffect.BigRedButton = ClickerSystem.RegisterClickEffect(Mod, "BigRedButton", null, null, 25, new Color(230, 100, 20, 0), delegate (Player player, ProjectileSource_Item_WithAmmo source, Vector2 position, int type, int damage, float knockBack)
			{
