...
namespace ClickerClass.Items.Accessories
{
	...
	public class RegalClickingGlove : ClickerItem
	{
		public override void SetStaticDefaults()
		{
			...
			DisplayName.AddTranslation(GameCulture.Russian, "Королевская кликающая перчатка");
			Tooltip.AddTranslation(GameCulture.Russian, "Пока вы в бою, автоматически активирует ваш курсор каждые полсекунды");
		}
