...
namespace ClickerClass.Items.Armors
{
	...
	public class PrecursorBreastplate : ClickerItem
	{
		...
		public override void UpdateEquip(Player player)
		{
			...
			//TODO 1.4.5 tooltip is not really accurate here, but changing it to a multiplicative decrease with 1-x would be an even stronger effect, needs revisiting
		}
