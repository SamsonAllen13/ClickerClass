...
namespace ClickerClass.Items.Weapons.Clickers
{
	public class AdamantiteClicker : ClickerWeapon
	{
		public override void SetStaticDefaults()
		{
			...
			ClickEffect.TrueStrike = ClickerSystem.RegisterClickEffect(Mod, "TrueStrike", 10, new Color(255, 25, 25), delegate (Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, int type, int damage, float knockBack)
			{
