...
namespace ClickerClass.Items.Weapons.Clickers
{
	public class LihzahrdClicker : ClickerWeapon
	{
		public override void SetStaticDefaults()
		{
			...
			{
				Projectile.NewProjectile(source, player.GetModPlayer<ClickerPlayer>().clickerPosition, Vector2.Zero, ModContent.ProjectileType<LihzarhdClickerPro>(), (int)(damage * 0.5f), 0f, player.whoAmI);
			});
		}
