...
namespace ClickerClass.Items.Weapons.Clickers
{
	public class MyceliumClicker : ClickerWeapon
	{
		public override void SetStaticDefaults()
		{
			...
			ClickEffect.Spores = ClickerSystem.RegisterClickEffect(Mod, "Spores", null, null, 10, new Color(115, 150, 220), delegate (Player player, ProjectileSource_Item_WithAmmo source, Vector2 position, int type, int damage, float knockBack)
			{
