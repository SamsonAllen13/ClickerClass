...
namespace ClickerClass.Items.Weapons.Clickers
{
	public class PalladiumClicker : ClickerWeapon
	{
		public override void SetStaticDefaults()
		{
			...
			ClickEffect.Regenerate = ClickerSystem.RegisterClickEffect(Mod, "Regenerate", 8, new Color(250, 150, 100), delegate (Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, int type, int damage, float knockBack)
			{
