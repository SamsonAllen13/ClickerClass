...
namespace ClickerClass.Tiles.Mice
{
	public class MiceChair : ModTile
	{
		...
		{
			Item.NewItem(WorldGen.GetItemSource_FromTileBreak(i, j), i * 16, j * 16, 16, 32, ModContent.ItemType<Items.Placeable.Mice.MiceChair>());
		}
		...
		public override void MouseOver(int i, int j)
		{
			...
			int item = ModContent.ItemType<Items.Placeable.Mice.MiceChair>();
			if (item > 0)
			{
